...
import { clients, companyData, heroImage, navItems, servicesData } from "./data/companyProfileData";
import { projectLocations } from "./data/projectLocations";

const DEFAULT_ROUTE = "/beranda";
const VALID_ROUTES = new Set(["/beranda", "/profil", "/layanan", "/produksi", "/pelanggan", "/kontak"]);
...
export default function App() {
    ...
    return (
        <div className="min-h-screen bg-[var(--bg)] text-[var(--ink)]">
            ...
            <Footer companyData={companyData} navItems={navItems} onNavigate={handleNavigate} />
        </div>
    );
}
