                ...
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                    ...
                    <Reveal as="div" className="mb-12 text-center">
                        ...
                        <p className="mt-4 text-[0.97rem] leading-relaxed text-gray-500 max-w-xl mx-auto">
                            Isi formulir di bawah untuk mendapatkan gambaran awal dan rekomendasi layanan dari tim CV
                            Karya Indah.
                        </p>
                    </Reveal>
                    ...
                    <Reveal as="div" delay={80}>
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            {submitState.status !== 'idle' && (
                                <div
                                    className={`rounded-xl border px-4 py-3 text-[0.87rem] ${
                    ...
                    <RevealStagger as="div" className="grid gap-5 sm:grid-cols-3" stagger={70}>
                        <div className="rounded-2xl bg-white border border-gray-100 p-7 shadow-sm transition duration-300 hover:-translate-y-1">
                            ...
                            <a
                                ...
                                className="text-[0.87rem] font-semibold text-[var(--color-primary-600)] hover:underline underline-offset-4"
                            >
                                {companyData.email}
                            </a>
                        </div>
                        ...
                        <div className="rounded-2xl bg-white border border-gray-100 p-7 shadow-sm transition duration-300 hover:-translate-y-1">
                            ...
                            <a
                                href="https://maps.app.goo.gl/gHhTQ7mLCE498mMo6"
                                target="_blank"
                                rel="noreferrer"
                                className="text-[0.87rem] font-semibold text-[var(--color-primary-600)] hover:underline underline-offset-4"
                            >
