        ...
        <Reveal as="div" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-8 sm:mb-10">
            ...
            <p className="mt-4 text-[0.97rem] leading-relaxed text-gray-500">
              Berbagai perusahaan terkemuka di Indonesia telah mempercayakan kebutuhan branding dan konstruksi visual
              mereka kepada kami.
            </p>
          </div>
        </Reveal>
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal as="div">
            <div className="mx-auto max-w-2xl text-center mb-8 sm:mb-12">
              ...
              <h2 className="font-bold text-[2rem] sm:text-[2.5rem] leading-tight text-gray-900">Mengapa Pilih Kami</h2>
              <p className="mt-4 text-[0.97rem] leading-relaxed text-gray-500">
            ...
            {advantages.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-[1.05rem] sm:text-[1.15rem] text-gray-900 mb-2 sm:mb-3">
                    {item.title}
                  </h3>
                  <p className="text-[0.88rem] sm:text-[0.9rem] leading-6 sm:leading-7 text-gray-600">
                    {item.description}
                  </p>
                </div>
              );
          ...
          <Reveal as="div" className="mt-8 sm:mt-12">
            <div className="rounded-2xl bg-[var(--color-primary-600)] px-5 py-8 sm:px-8 sm:py-10 text-center text-white">
              ...
              <p className="text-white/80 text-[0.92rem] sm:text-[0.97rem] mb-5 sm:mb-7 max-w-xl mx-auto">
                Konsultasikan kebutuhan branding, signage, atau konstruksi visual bisnis Anda bersama tim CV Karya
                Indah.
              </p>
...
function HeroContent({ companyData, onNavigate }) {
  return (
    <div className="flex flex-col items-center text-center max-w-4xl">
      <h1 className="motion-fade-up-delayed font-bold text-white leading-tight text-[1.75rem] sm:text-[2.1rem] lg:text-[3rem]">
        {companyData.tagline}
        <br />
      </h1>
      <p className="motion-rise-in text-white/80 leading-relaxed mt-4 max-w-lg text-[1rem] sm:mt-5 sm:max-w-2xl lg:text-[1.15rem]">
        Layanan branding, signage, interior, dan konstruksi visual yang profesional untuk bisnis dan institusi di
        seluruh Indonesia.
      </p>
      <div className="motion-rise-in flex flex-wrap justify-center mt-7 gap-3 sm:mt-9 sm:gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-lg border border-white/30 bg-white/10 font-semibold text-white backdrop-blur-sm transition hover:bg-white/20 px-6 py-3 text-[0.95rem] sm:px-8 sm:py-3.5 sm:text-[1rem]"
        >
          Lihat Layanan
        </button>
      </div>
