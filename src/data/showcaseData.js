...
const baseProductionGallery = [
  ...
  ...createSeriesItems({
    ...
    images: [
      '/produksi/produksi18.png',
      '/produksi/produksi19.png',
      '/produksi/produksi20.png',
      '/produksi/produksi32.png',
    ],
  }),
  ...createSeriesItems({
    title: 'Showroom & Service Yamaha',
    category: 'Dealer Interior',
    subtitle: 'Interior showroom dan area layanan dealer Yamaha',
    note: 'Dokumentasi interior dealer Yamaha mencakup area kasir, bengkel servis, serta ruang tunggu pemeliharaan yang tertata rapi untuk kenyamanan pelanggan.',
    meta: ['Dealer interior', 'Service center', 'Showroom Yamaha'],
    images: [
      '/produksi/produksi21.png',
      '/produksi/produksi22.png',
      '/produksi/produksi23.png',
    ],
  }),
  ...createSeriesItems({
    ...
    images: [
      '/produksi/produksi24.png',
      '/produksi/produksi25.png',
      '/produksi/produksi26.png',
    ],
  }),
  ...createSeriesItems({
    title: 'Interior Toko Yo! Active',
    category: 'Retail Interior',
    subtitle: 'Interior toko fashion dan alas kaki Yo! Active',
    note: 'Dokumentasi interior toko Yo! Active dengan display produk yang menarik, area sepatu yang tertata rapi, dan konsep ruangan yang dinamis sesuai identitas brand.',
    meta: ['Retail interior', 'Fashion store', 'Yo! Active'],
    images: [
      '/produksi/produksi27.png',
      '/produksi/produksi28.png',
      '/produksi/produksi29.png',
      '/produksi/produksi30.png',
    ],
  }),
  ...createSeriesItems({
    title: 'Service Center Chery',
    category: 'Dealer Support',
    subtitle: 'Area servis resmi Chery yang modern',
    note: 'Area service center Chery dengan tata ruang profesional dan identitas brand yang jelas, dirancang untuk kenyamanan pelanggan dalam proses perawatan kendaraan.',
    meta: ['Service center', 'Dealer support', 'Chery'],
    images: [
      '/produksi/produksi31.png',
    ],
  }),
];
